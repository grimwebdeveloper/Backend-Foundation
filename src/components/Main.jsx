...
const Main = () => {
  return (
    <main className='max-w-screen-xl mx-auto p-4'>
      ...
      />
      <h2 className='text-center relative font-extrabold z-50 text-[12vw] xl:text-[153.6px] md:mt-32 h-screen'>
        Floral Fragility
      </h2>
      <section className='min-h-screen py-8 md:py-12 xl:py-16 lg:w-1/2 lg:ml-auto md:px-16 lg:px-0'>
      ...
      <section className='min-h-screen py-8 md:py-12 xl:py-16 flex flex-col gap-64 items-center justify-center lg:w-1/2 lg:ml-auto'>
